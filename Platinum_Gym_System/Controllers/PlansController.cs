...
namespace Platinum_Gym_System.Controllers
{
    ...
    public class PlansController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PlanId,Name,Description,DurationMonths,Price,State")] Plan plan)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PlanId,Name,Description,DurationMonths,Price,State")] Plan plan)
        {
            if (id != plan.PlanId)
            {
                return NotFound();
